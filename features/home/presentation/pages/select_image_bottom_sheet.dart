...
import '../../../../../features/panels/profile_panel/presentation/manager/profile_panel_view_model.dart';
                ...
                Wrap(
                  children: <Widget>[
                    ListTile(
                      ...
                      onTap: () async {
                        await profilePanelViewModel.getImageFromGallery();
                        Navigator.of(context).pop();
                      },
                    ),
                    ListTile(
                      ...
                      onTap: () async {
                        await profilePanelViewModel.getImageFromCamera();
                        Navigator.of(context).pop();
                      },
                    ),
                  ],
